...
export default function Basic({ value2,tg,Brands,Models,Defects,varBrand,varDefect,varModel }) {
  ...
  console.log(Brands)
  console.log(Models)
  const ThiredApiData=value2.new_value;
  console.log(ThiredApiData)
  ...
  const FetchApiData = async () => {
    try {
      const response = await axios.get(`http://18.221.148.248:84/api/v1/Brand/GetModelDefectsforDropdown?modelId=${ThiredApiData}`);
